...
void CChaosCastle::GiveUserRewardItem(CHAOS_CASTLE_LEVEL* lpLevel,int aIndex) // OK
{
	...
	{
		//Reward
		GDSetCoinSend(lpUser->Index, this->m_ChaosCastleRewardValue[lpLevel->Level][0], this->m_ChaosCastleRewardValue[lpLevel->Level][1], this->m_ChaosCastleRewardValue[lpLevel->Level][2], 0, "CC");
