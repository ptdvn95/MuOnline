...
CCustomNpcReq gCustomNpcReq;
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CCustomNpcReq::CCustomNpcReq() // OK
{
	this->m_CustomNpcReq.clear();
}
...
void CCustomNpcReq::Load(char* path) // OK
{
	...
	try
	{
		while (true)
		{
			...
			this->m_CustomNpcReq.insert(std::pair<int, NPC_REQUIERE_INFO>(info.Index, info));
		}
	}
	catch (...)
	{
...
bool CCustomNpcReq::CheckItem(LPOBJ lpObj, int npc) // OK
{
	int ItemOK;
	int Qtd;

	for (std::map<int, NPC_REQUIERE_INFO>::iterator it = this->m_CustomNpcReq.begin(); it != this->m_CustomNpcReq.end(); it++)
	{
...
void CCustomNpcReq::RemoveItem(LPOBJ lpObj, int npc) // OK
{
	int ItemOK;
	int QtdRemove;
...
bool CCustomNpcReq::GetNpcReq(LPOBJ lpObj, int MonsterClass, int Map, int X, int Y) // OK
{
	for (std::map<int, NPC_REQUIERE_INFO>::iterator it = this->m_CustomNpcReq.begin(); it != this->m_CustomNpcReq.end(); it++)
	{
