...
void CBloodCastle::GiveUserRewardItem(BLOOD_CASTLE_LEVEL* lpLevel,int aIndex) // OK
{
	...
	{
		//Reward
		GDSetCoinSend(lpUser->Index, this->m_BloodCastleRewardValue[lpLevel->Level][0], this->m_BloodCastleRewardValue[lpLevel->Level][1], this->m_BloodCastleRewardValue[lpLevel->Level][2],0,"BC");
