...
int CEventHideAndSeek::EventHideAndSeekTrade(int aIndex,int bIndex) // OK 
{
	...
	{	
		GDSetCoinSend(lpObj->Index, gServerInfo.m_EventHideAndSeekAutoReward1, gServerInfo.m_EventHideAndSeekAutoReward2, gServerInfo.m_EventHideAndSeekAutoReward3, 0, "HideAndSeek");
	}
