	...
	for(int n=0;n < MAX_SPECIAL;n++)
	{
		...
		switch(index)
		{
			...
			case ITEM_OPTION_ADD_PHYSI_DAMAGE_BY_LEVEL:
				lpObj->PhysiDamageMinRight += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
				lpObj->PhysiDamageMaxRight += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
				lpObj->PhysiDamageMinLeft += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
				lpObj->PhysiDamageMaxLeft += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
			...
			case ITEM_OPTION_ADD_MAGIC_DAMAGE_BY_LEVEL:
				lpObj->MagicDamageMin += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
				lpObj->MagicDamageMax += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
			...
			case ITEM_OPTION_ADD_CURSE_DAMAGE_BY_LEVEL:
				lpObj->CurseDamageMin += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
				lpObj->CurseDamageMax += ((lpObj->Level
#if (LEVEL_PLUS ==1)
					+ lpObj->LevelPlus
#endif
					+lpObj->MasterLevel)/value);
