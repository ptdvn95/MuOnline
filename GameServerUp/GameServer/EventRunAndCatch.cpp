...
void CEventRunAndCatch::EventRunAndCatchHit(int aIndex,int bIndex) // OK 
{
	...
	if (this->m_Members == 1)
	{
		...
		{	
			GDSetCoinSend(lpObj->Index, gServerInfo.m_EventRunAndCatchAutoReward1, gServerInfo.m_EventRunAndCatchAutoReward2, gServerInfo.m_EventRunAndCatchAutoReward3, 0, "RunAndCatch");
		}
