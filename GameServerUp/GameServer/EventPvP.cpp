...
void CEventPvP::MainProc() // OK
{
	...
	{ 
		...
		if (this->m_EventPvPActive && gObjIsConnectedGP(this->m_Player1Index) == 0) 
		{
			...
			{	
				GDSetCoinSend(this->m_Player2Index, gServerInfo.m_EventPvPAutoReward1, gServerInfo.m_EventPvPAutoReward2, gServerInfo.m_EventPvPAutoReward3, 0, "PvpEvent");
			}
		...
		if (this->m_EventPvPActive && gObjIsConnectedGP(this->m_Player2Index) == 0) 
		{
			...
			if (gServerInfo.m_EventPvPAutoReward1 > 0 || gServerInfo.m_EventPvPAutoReward2 > 0 || gServerInfo.m_EventPvPAutoReward3 > 0)
			{	
				GDSetCoinSend(this->m_Player1Index, gServerInfo.m_EventPvPAutoReward1, gServerInfo.m_EventPvPAutoReward2, gServerInfo.m_EventPvPAutoReward3, 0, "PvpEvent");
			}
