				...
				else 
				{
					...
					LogAdd(LOG_EVENT,"[EVENT RUSSIAN ROULETTE] %s Saved",lpObj->Name);
						...
						if (this->m_Members == 1)
						{
							...
							{	
								GDSetCoinSend(lpObj->Index, gServerInfo.m_EventRussianRouletteAutoReward1, gServerInfo.m_EventRussianRouletteAutoReward2, gServerInfo.m_EventRussianRouletteAutoReward3, 0, "RussianR.");
							}
