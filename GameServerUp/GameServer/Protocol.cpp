...
//Dragones function para chequear mapa de invasi�n y todos los personajes
...
void ProtocolCore(BYTE head,BYTE* lpMsg,int size,int aIndex,int encrypt,int serial) // OK
{
	...
	switch(head)
	{
...
#else
				case 0x02:
					gDuel.CGDuelOkRecvCUSTOM((PMSG_DUEL_OK_RECV_CUSTOM*)lpMsg, aIndex);
					break;
				case 0x03:
					//gDuel.CGDuelEndRecv(aIndex);
					break;
		...
		case 0xF3:
			...
			switch(lpMsg[3])
			{
				...
				case 0xF0:
					...
					break;
				case 0xD6:
					gChangeClass.SelectClass(aIndex, (CHANGE_REQ*)lpMsg);
					break;
				case 0xDF:
		...
		case 0xFD:
			...
			{
			case 0x00:
				gResetSystem.SendResetData(&gObj[aIndex], true);
				break;
			case 0x01:
				gResetSystem.FinishResetReq(&gObj[aIndex]);
				break;
			case 0x02:
