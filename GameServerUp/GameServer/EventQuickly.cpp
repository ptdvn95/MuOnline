...
void CEventQuickly::ClickNPC(LPOBJ lpObj) // OK 
{
	...
	{	
		GDSetCoinSend(lpObj->Index, gServerInfo.m_QuicklyEventAutoReward1, gServerInfo.m_QuicklyEventAutoReward2, gServerInfo.m_QuicklyEventAutoReward3, 0, "QuicklyEvent");
	}
