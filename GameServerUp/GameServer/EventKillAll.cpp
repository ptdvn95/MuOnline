			...
			for(int n=0;n < MAX_KILLALL_USER;n++)
			{
				if(OBJECT_RANGE(this->User[n].Index) != 0)
				{
					if(this->User[n].Rank == 1)
					{
						...
						{	
							GDSetCoinSend(this->User[n].Index, gServerInfo.m_EventKillAllAutoReward1[0], gServerInfo.m_EventKillAllAutoReward2[0], gServerInfo.m_EventKillAllAutoReward3[0], 0, "KillAll");
						}
					...
					if(this->User[n].Rank == 2)
					{
						...
						{	
							GDSetCoinSend(this->User[n].Index, gServerInfo.m_EventKillAllAutoReward1[1], gServerInfo.m_EventKillAllAutoReward2[1], gServerInfo.m_EventKillAllAutoReward3[1], 0, "KillAll");
						}
					...
					if(this->User[n].Rank == 3)
					{
						...
						{	
							GDSetCoinSend(this->User[n].Index, gServerInfo.m_EventKillAllAutoReward1[2], gServerInfo.m_EventKillAllAutoReward2[2], gServerInfo.m_EventKillAllAutoReward3[2], 0, "KillAll");
						}
