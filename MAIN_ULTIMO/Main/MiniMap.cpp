...
CMinimap::CMinimap()
{
	...
	this->DataMap.YSW_Minimap = 320.0; //-- MiniMapY (Minimapa Arriba) (Mover Minimapa Arriba o Abajo)
    ...
    this->ultimoY = 320.0;//Example of initial coordinate {Y}. Coordinate that will be constantly modified.
}
