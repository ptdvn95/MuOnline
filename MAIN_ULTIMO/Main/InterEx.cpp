...
void SDCurrentLive()
{
	...
	{
		gTextColor.CUIPaintFont((float)Return2X(XSDCoord + TransForX(129.25)), (float)ReturnY(TransForY(440)), String, 0, 8);
	}
...
void BPCurrentLive()
{
	...
	{
		gTextColor.CUIPaintFont((float)Return2X(XBPCoord + TransForX(424)), ReturnY(YBPCoord) + 9, String, 0, 8);
	}
	//-- MP
	gTextColor.SetFontColor(255, 255, 255, 255);
	ZeroMemory(String, sizeof(String));
	...
	{
		gTextColor.CUIPaintFont((float)Return2X(XBPCoord + TransForX(495.75)), (float)ReturnY(TransForY(440)), String, 0, 8);
	}
	pSetFont(pTextThis(), (int)*(HGDIOBJ*)0xE8C588);
}
