	...
	for (int n = 0; n < MAX_MAIN_VIEWPORT; n++)
	{
		...
		if (lpNewHealthBar->type == emPlayer/* && istarget*/)
		{
			if (HPMonsterName == 1)
			{
				...
				if (isPartyMember)
				{
					glColor4f(RGBTOGLFLOAT(63), RGBTOGLFLOAT(124), RGBTOGLFLOAT(204), 0.9); // ���� ���� ��� �����
				}
				else if (lpNewHealthBar->isSameGuild)
				{
					glColor4f(RGBTOGLFLOAT(18), RGBTOGLFLOAT(226), RGBTOGLFLOAT(131), 0.9); // ���� ���� ��� �����
				}
				else
				{
		...
		else
		{
			...
			if (HpBarEx == 0)
			{
				if (HPMonsterName == 1)
				{
					...
					else
					{
						...
						DrawInterfaceText(lpObj->Name, PosX - 1, PosY - 21, 67, 1, eWhite, 9, 3); // ���� �����
						DrawInterfaceText(Text, PosX - 1, PosY - 11, 67, 1, eWhite, 9, 3); // ���� ����
					}
				}
			}
			else
			{
				if (HPMonsterName == 1)
				{
					glColor4f(RGBTOGLFLOAT(HpBarEx->Red), RGBTOGLFLOAT(HpBarEx->Green), RGBTOGLFLOAT(HpBarEx->Blue), HpBarEx->Opacity); // ���� ���� ��� �����
