...
{
	//--------------------------------
	// Nuevo C�digo Interface Downgrade
	//--------------------------------
	RenderSlot = -1;
	...
	SetByte((PVOID)(0x007E4CB9 + 1), 0);	//Cambia el n�mero del chaos

	SetCompleteHook(0xE9, 0x00425468, &SlideShow);

	SetDword((PVOID)(0x007D0EF6 + 1), 350); //POSI��O Y GUILD MASTER BUTTONS PART1
	SetDword((PVOID)(0x007D0F5D + 1), 350); //POSI��O Y GUILD MASTER BUTTONS PART1
	SetByte((PVOID)(0x007D0F05 + 2), 43); //POSI��O X GUILD MASTER BUTTONS PART1
	SetByte((PVOID)(0x007D0F6C + 2), 88); //POSI��O X GUILD MASTER BUTTONS PART1
	SetDword((PVOID)(0x007D11DE + 2), 350); //POSI��O Y GUILD MASTER BUTTONS PART2
	SetDword((PVOID)(0x007D1249 + 2), 350); //POSI��O Y GUILD MASTER BUTTONS PART2
	SetByte((PVOID)(0x007D11EE + 2), 43); //POSI��O X GUILD MASTER BUTTONS PART2
	SetByte((PVOID)(0x007D1259 + 2), 88); //POSI��O X GUILD MASTER BUTTONS PART2
